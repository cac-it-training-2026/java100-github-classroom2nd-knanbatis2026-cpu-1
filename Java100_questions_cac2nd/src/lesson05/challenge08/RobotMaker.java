...
class Robot {
	...
	public void randomWater() {
		this.water = (int) (Math.random() * 10);
	}

	public void makeOmelet(int eggNum, int butterNum) {
		int omeletCount = 0;
		omeletCount = Math.min((int) (eggNum / 2), (int) (butterNum / 5));
		System.out.println(omeletCount + "人分のオムレツを作成しました。");
		System.out.println();
	}
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		String dish = robot.makeEggDishes(flourNum, sugarNum, eggNum, butterNum);
